...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action ref={ref} className={classnames(buttonVariants(), className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ref={ref}
    className={classnames(buttonVariants({ variant: "outline" }), "mt-2 sm:mt-0", className)}
    {...props}
  />
));
